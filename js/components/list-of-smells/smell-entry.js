define([
    ...
    var SmellEntry = function (analysisResult) {
        var startLine = analysisResult.startLine,
            endLine = analysisResult.endLine,
            selectExtension;

        this.analysisResult = ko.observable(analysisResult);
        this.title = ko.observable(analysisResult.codeSmell.name);
        this.info = ko.observable(analysisResult.codeSmell.info);
        ...
        this.suggestedRefactorings = ko.observableArray(analysisResult.codeSmell.suggestedRefactorings);
